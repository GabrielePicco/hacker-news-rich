...
function slidebar() {
  var t = $(".ms-slidebar"), o = $(".ms-site-container"), n = $(".ms-toggle-left"), e = !1, i = !1;
  n.click(function () {
...
!function (c, p, t) {
  ...
  c.fn.dropdownHover = function (l) {
    return "ontouchstart" in document ? this : (u = u.add(this.parent()), this.each(function () {
      ...
      }, a = "show.bs.dropdown", s = c.extend(!0, {}, {delay: 0, hoverDelay: 0, instantlyCloseOthers: !0}, l, t);
  ...
  $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $("#status").fadeOut(), $("#ms-preload").delay(350).fadeOut("slow"), $("body").delay(350).css({overflow: "visible"}), (new WOW).init();
  ...
  var n = $(".ms-navbar"), e = ($(".navbar-nav"), $("body")), i = $(".ms-site-container").hasClass("ms-nav-fixed");
  $(window).scroll(function () {
  ...
  a.expr[":"].notmdproc = function (t) {
    ...
    options: {
      ...
      a(t || this.options.inputElements).filter(":notmdproc").data("mdproc", !0).each(function () {
        var n = a(this), e = n.closest(".form-group");
      ...
      a(document).on("keydown paste", ".form-control", function (t) {
        ...
        var t = a(this), o = t.closest(".form-group"), n = void 0 === t[0].checkValidity || t[0].checkValidity();
        ...
        var t = a(this).closest(".form-group"), n = "";
...
}(jQuery), function (r, l, o, n) {
  "use strict";
  var e = "ripples", c = null, i = {};
  ...
  a.prototype.init = function () {
    ...
    s.on("mousedown touchstart", function (t) {
      if (!c.isTouch() || "mousedown" !== t.type) {
        ...
        var o = s.children(".ripple-container"), n = c.getRelY(o, t), e = c.getRelX(o, t);
        if (n || e) {
          var i = c.getRipplesColor(s), a = r("<div></div>");
    ...
    t.off(), c.hasTransitionSupport() ? t.addClass("ripple-out") : t.animate({opacity: 0}, 100, function () {
